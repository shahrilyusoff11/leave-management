        ...
        <div className="space-y-6">
            ...
            {statsLoading ? (
                <div className="flex flex-col items-center justify-center py-20 bg-white rounded-xl border border-dashed border-slate-200">
                    ...
                    <p className="text-slate-500 font-medium text-lg">Crunching your numbers...</p>
                    <p className="text-slate-400 text-sm mt-1">Gathering latest statistics and activity</p>
                </div>
            ) : (
                <>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <Card>
                            ...
                            <CardContent className="h-80">
                                {stats && stats.type_counts && stats.type_counts.length > 0 ? (
